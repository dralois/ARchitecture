...
public class ShadowRendererData : ScriptableRendererData
{
#if UNITY_EDITOR
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1812")]
	internal class CreateShadowRender : EndNameEditAction
	{
		public override void Action(int instanceId, string pathName, string resourceFile)
		{
			var instance = CreateInstance<ShadowRendererData>();
	...
	[MenuItem("Assets/Create/Rendering/Universal Render Pipeline/Shadow Renderer", priority = CoreUtils.assetCreateMenuPriority2)]
	static void CreateForwardRendererData()
	{
		ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateShadowRender>(), "CustomForwardRendererData.asset", null, null);
	}
#endif
